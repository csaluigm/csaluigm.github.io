export var hotelGroups = [
  [
    {
      name: 'Pamplona El Toro Hotel & Spa ',
      stars: 4,
      website:
        'https://www.luzehoteles.com/luze-el-toro/?gclid=CjwKCAiAk9itBhASEiwA1my_6_apf-tpUwaObd-_ZPg9CAuGAnuWDk-Uom5TVPvHrU5v_n4214h1sBoC-i8QAvD_BwE',
  ...
  [
    ...
    {
      name: 'Hotel Ciudadela Pamplona',
      stars: 3,
      website: 'https://www.hotelciudadela.es/es/',
      link: 'https://maps.app.goo.gl/KGZoHxYtht16BeDG7',
    },
  ],
  [
    {
      name: 'Hotel Sercotel Europa',
      stars: 3,
      website: 'https://www.hoteleuropapamplona.com/',
      link: 'https://maps.app.goo.gl/qtqXqS7AbxF1K3hJA',
    },
    {
      name: 'Hotel Yoldi Pamplona',
      stars: 3,
      website: 'https://www.hotelyoldi.com/',
