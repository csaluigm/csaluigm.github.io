export var planning = [
  {
    title: 'Ceremonia',
    location: 'Iglesia de San Lorenzo (Pamplona)',
    time: '11:45',
...
// export var mainText = "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts."
